...
def test_post_conv_1():
    ...
    c0_num_lines = db.characters[4386].num_lines
    c1_num_lines = db.characters[4376].num_lines
    ...
    assert len(db.lines_log) == len_lines_log + 2
    assert db.characters[4386].num_lines == c0_num_lines + 1
    assert db.characters[4376].num_lines == c1_num_lines + 1
    assert db.lines_log[-2]["line_text"] == "Nice to meet you."
    assert db.lines_log[-1]["line_text"] == "You too!"
